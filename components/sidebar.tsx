...
export function Sidebar() {
  ...
  return (
    <>
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <Link
                  ...
                  className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-50"
                >
                  <svg
                    className="h-5 w-5 text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-50"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
      ...
      {/* Mobile bottom nav */}
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-zinc-200 bg-white lg:hidden dark:border-zinc-800 dark:bg-zinc-900">
